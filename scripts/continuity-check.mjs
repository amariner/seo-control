...
const required = [
  ...
  "docs/continuity/v1-migration-inventory.json",
  "docs/continuity/V1_MIGRATION_INVENTORY.md",
  "docs/continuity/v1-reconciliation-baseline.json",
  "docs/continuity/V1_RECONCILIATION.md",
  "docs/continuity/P2_ACCEPTANCE.md",
